          ...
          child: ListTile(
            ...
            leading: Container(
              ...
              decoration: BoxDecoration(
                ...
                color: item.artUrl.startsWith('color:')
                    ? _parseColor(item.artUrl)
                    : null,
                image: !item.artUrl.startsWith('color:')
                    ? DecorationImage(
              ...
              child: item.artUrl.startsWith('color:')
                  ? null
                  : (File(item.artUrl).existsSync()
                        ? null
                        : Container(
